...
void D_DoomLoop (void)
{
    ...
    {
        printf(" WARNING: You are playing using one of the Classic Doom\n"
               " IWAD files from Doom 3: BFG Edition. These are\n"
               " known to be incompatible with the regular IWAD files, and\n"
               " may cause demos and network games to desync.\n");
    }
...
static const char *copyright_banners[] =
{
    ...
    "get the original game, you should buy it on GOG.com or Steam \n"
    "        You will not receive technical support from ID for modified games.\n"
